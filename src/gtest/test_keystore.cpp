...
TEST(KeystoreTests, StoreAndRetrieveSaplingSpendingKey) {
    ...
    EXPECT_FALSE(keyStore.HaveSaplingExtendedFullViewingKey(ivk));
    EXPECT_FALSE(keyStore.GetSaplingExtendedFullViewingKey(ivk, extfvkOut));
    ...
    EXPECT_TRUE(keyStore.HaveSaplingExtendedFullViewingKey(ivk));
    EXPECT_TRUE(keyStore.GetSaplingExtendedFullViewingKey(ivk, extfvkOut));
